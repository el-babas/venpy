...
{
    public partial class MAIN008LView : UserControl, IMAIN008LView
    {
        #region [ PROPERTIES ]
        ...
        public MAIN008LView(TabPage p_tabPageControl)
        {
        ...
        public void Search()
        {
            ...
            {
                CleanDataGridView();
                Presenter.Search(txtPRLI_Name.Text);
                FillDataGridView();
            }
            catch (Exception ex)
        ...
        private void CreateGridColumns()
        {
            try
            {
                ...
                dgvItems.AddTextBoxColumn("NOMBRE", "PRLI_Name", "PRLI_Name", 300, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("MONEDA", "TBLE_NameMND", "TBLE_NameMND", 150, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddCheckBoxColumn("ACTIVO", "PRLI_Active", "PRLI_Active", 100, true);
                dgvItems.AddTextBoxColumn("CÓDIGO", "PRLI_Code", "PRLI_Code", 100, true, null, DataGridViewContentAlignment.MiddleCenter);
        ...
        private void SelectItem()
        {
            try
            {
                if (Presenter != null)
                {
                    if (BSItems != null && BSItems.Current != null && BSItems.Current is VENPY_PriceList)
                    { Presenter.ItemGridView = ((VENPY_PriceList)BSItems.Current); }
                    else
