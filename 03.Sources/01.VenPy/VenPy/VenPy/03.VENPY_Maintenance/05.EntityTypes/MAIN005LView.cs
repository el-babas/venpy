...
{
    public partial class MAIN005LView : UserControl, IMAIN005LView
    {
        #region [ PROPERTIES ]
        ...
        public MAIN005LView(TabPage p_tabPageControl)
        {
        ...
        public void Search()
        {
            ...
            {
                CleanDataGridView();
                Presenter.Search(txtETYP_Name.Text);
                FillDataGridView();
            }
            catch (Exception ex)
        ...
        private void CreateGridColumns()
        {
            try
            {
                ...
                dgvItems.AddTextBoxColumn("NOMBRE", "ETYP_Name", "ETYP_Name", 250, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("DESCRIPCIÓN", "ETYP_Description", "ETYP_Description", 400, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddCheckBoxColumn("ACTIVO", "ETYP_Active", "ETYP_Active", 200, true);
                dgvItems.AddTextBoxColumn("CÓDIGO", "ETYP_Code", "ETYP_Code", 100, true, null, DataGridViewContentAlignment.MiddleCenter);

                dgvItems.AddCheckBoxColumn("DEFECTO", "ETYP_Default", "ETYP_Default", 200, true);
                dgvItems.Columns["ETYP_Default"].Visible = false;
        ...
        private void SelectItem()
        {
            try
            {
                if (Presenter != null)
                {
                    if (BSItems != null && BSItems.Current != null && BSItems.Current is VENPY_EntityTypes)
                    { Presenter.ItemGridView = ((VENPY_EntityTypes)BSItems.Current); }
                    else
