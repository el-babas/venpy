...
{
    public partial class MAIN003LView : UserControl, IMAIN003LView
    {
        #region [ PROPERTIES ]
        ...
        public MAIN003LView(TabPage p_tabPageControl)
        {
        ...
        public void Search()
        {
            ...
            {
                CleanDataGridView();
                Presenter.Search(txtBOFF_Name.Text);
                FillDataGridView();
            }
            catch (Exception ex)
        ...
        private void CreateGridColumns()
        {
            try
            {
                ...
                dgvItems.AddTextBoxColumn("NOMBRE", "BOFF_Name", "BOFF_Name", 300, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("DIRECCIÓN", "BOFF_Address", "BOFF_Address", 350, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("DEPARTAMENTO", "BOFF_Departamento", "BOFF_Departamento", 200, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("PROVINCIA", "BOFF_Provincia", "BOFF_Provincia", 200, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("DISTRITO", "BOFF_Distrito", "BOFF_Distrito", 200, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("CÓDIGO", "BOFF_Code", "BOFF_Code", 100, true, null, DataGridViewContentAlignment.MiddleCenter);
        ...
        private void SelectItem()
        {
            try
            {
                if (Presenter != null)
                {
                    if (BSItems != null && BSItems.Current != null && BSItems.Current is VENPY_BranchOffices)
                    { Presenter.ItemGridView = ((VENPY_BranchOffices)BSItems.Current); }
                    else
