...
{
    public partial class MAIN002LView : UserControl, IMAIN002LView
    {
        #region [ PROPERTIES ]
        ...
        public MAIN002LView(TabPage p_tabPageControl)
        {
        ...
        public void Search()
        {
            ...
            {
                CleanDataGridView();
                Presenter.Search(txtBUSI_RUC.Text, txtBUSI_BusinessName.Text);
                FillDataGridView();
            }
            catch (Exception ex)
        ...
        private void CreateGridColumns()
        {
            try
            {
                ...
                dgvItems.AddTextBoxColumn("RUC", "BUSI_RUC", "BUSI_RUC", 150, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("RAZÓN SOCIAL", "BUSI_BusinessName", "BUSI_BusinessName", 300, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("NOMBRE COMERCIAL", "BUSI_TradeName", "BUSI_TradeName", 300, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("DIRECCIÓN", "BUSI_Address1", "BUSI_Address1", 350, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("URBANIZACIÓN", "BUSI_Urbanization", "BUSI_Urbanization", 250, true, null, DataGridViewContentAlignment.MiddleLeft);
                dgvItems.AddTextBoxColumn("DEPARTAMENTO", "BUSI_Departamento", "BUSI_Departamento", 200, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("PROVINCIA", "BUSI_Provincia", "BUSI_Provincia", 200, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("DISTRITO", "BUSI_Distrito", "BUSI_Distrito", 200, true, null, DataGridViewContentAlignment.MiddleCenter);
                dgvItems.AddTextBoxColumn("CÓDIGO", "BUSI_Code", "BUSI_Code", 100, true, null, DataGridViewContentAlignment.MiddleCenter);
            }
            catch (Exception ex)
        ...
        private void SelectItem()
        {
            try
            {
                if (Presenter != null)
                {
                    if (BSItems != null && BSItems.Current != null && BSItems.Current is VENPY_Business)
                    { Presenter.ItemGridView = ((VENPY_Business)BSItems.Current); }
                    else
        ...
        private void ValidateAccess()
        {
            try
            {
                tlpButtons.ColumnStyles[2].Width = 0;
                btnNew.Visible = false;
                if (SessionVariables.UserType.Equals(StaticLists.USER_Root))
                {
                    tlpButtons.ColumnStyles[2].Width = 117;
                    btnNew.Visible = true;
